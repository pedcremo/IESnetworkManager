...
class GoogleAppsBackend:
 ...
 def authenticate(self, username=None, password=None):
	 ...
	 print 'Before GoogleAppsBackend.authenticate: user - %s' % username
         ...
         # Get the user object
	 print 'After GoogleAppsBackend.authenticate: user - %s' % username
	 ...
	 print '2 After GoogleAppsBackend.authenticate: user - %s' % username
         gapps.ProgrammaticLogin()
	 print '3 After GoogleAppsBackend.authenticate: user - %s' % username
         guser = gapps.RetrieveUser(username)
	 print '4 After GoogleAppsBackend.authenticate: user - %s' % username
